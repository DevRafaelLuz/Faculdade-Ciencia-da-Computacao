# 1. Desenvolva um método que implemente o AES
#   1.1 O método deve receber um texto e uma senha e retornar o conteúdo criptografado
#   1.2 Também deve ser possível decodificar o texto, desde que seja informada uma senha correta
